            ...
            return (
              ...
              >
                ...
                <div className="flex-1">
                  <h3 className="w-fit font-bold text-xl sm:text-3xl mb-2 sm:mb-2.5 text-primary-green">
                    {journal.name}
                  </h3>
                  <p className="text-sm/normal sm:text-lg/normal text-primary-black/65 line-clamp-2 max-w-prose">
                    {journal.excerpt}
                  </p>
                </div>
              </Link>
