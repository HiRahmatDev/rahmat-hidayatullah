...
export function Footer() {
  return (
    <footer className="bg-light-green">
      <div className="max-w-300 mx-auto px-4 sm:px-12 pt-10 pb-10 sm:pb-20 overflow-hidden flex flex-col sm:flex-row gap-8 items-start sm:items-end justify-between">
        <div>
          <VisualAccent variant="secondary" />
          <p className="font-bold text-2xl/tight sm:text-[28px]/tight mt-4 mb-5 max-w-[320px] lg:max-w-[unset]">
            Senang bisa berbagi{" "}
